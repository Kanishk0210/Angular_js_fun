...
public final class index1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            \n");
      out.write("            <input type=\"button\" value=\"1\" ng-model=\"i\"/>\n");
      out.write("            <input type=\"button\" value=\"2\" ng-model=\"5\"/>\n");
      out.write("            <table border=\"1\" ng-controller=\"myctrl\">\n");
      out.write("                <tr><td>id</td><td>name</td><td>salary</td></tr>\n");
      out.write("                \n");
      out.write("                <tr ng-repeat=\"x in data| limitTo:5:i\">{{x}}<td>{{x.id}}</td><td>{{x.name|uppercase}}</td><td>{{x.salary}}</td></tr>\n");
      out.write("                \n");
      out.write("            </table>\n");
      out.write("                <div ng-controller=\"myController1\">\n");
      out.write("                <select ng-model=\"s\">\n");
      out.write("                    <option ng-repeat=\"x in data\" value=\"{{x.name}}\">{{x.name}}</option>\n");
      out.write("                   \n");
      out.write("                </select>   \n");
      out.write("                     \n");
      out.write("                    <br>\n");
      out.write("                    selected name :{{s}} \n");
      out.write("                    \n");
      out.write("                </div>\n");
      out.write("            <input type=\"number\" ng-model=\"p\"/>\n");
      out.write("            <input type=\"number\" ng-model=\"q\"/>\n");
      out.write("            <select ng-model=\"s1\" >\n");
      ...
      out.write("            </select>\n");
      out.write("            <br>\n");
      out.write("            <div ng-switch=\"s1\">\n");
      out.write("                <div ng-switch-when=\"+\">{{p+q}}</div>\n");
      out.write("                <div ng-switch-when=\"-\">{{p-q}}</div>\n");
      out.write("                <div ng-switch-when=\"*\">{{p*q}}</div>\n");
      out.write("                <div ng-switch-when=\"/\">{{p/q}}</div>\n");
      out.write("            </div>\n");
